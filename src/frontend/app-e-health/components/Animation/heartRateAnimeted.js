...
const heartRateAnimeted = () => {
    const clock1 = useClockValue();
    const expo = useImage(require("../../assets/img/expo.png"));
    const heart = useImage(require("../../assets/img/heart.png"));
...
export default heartRateAnimeted;
